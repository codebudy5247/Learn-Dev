...
var student1=new createStudent("aditya", 20, 30);
var student2=new createStudent("shekhar", 25, 33);
...
class Vehicles {
    constructor(number_of_wheels, color) {
        ...
        //if i dont add constructor, a default empty constructor will be
        //added by itself
    get_color() {
        return this.color;
    }
...
console.log(vehicle2.number_of_wheels);
...
class Car extends Vehicle /* inheritance */ {
    ...
    print_description() {
        ...
        console.log(`This car has  ${this.number_of_doors} number of doors and in  ${this.color} colour`);
    }
}
